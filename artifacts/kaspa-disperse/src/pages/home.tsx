  ...
  return (
    <LandingLayout>
      <section className="relative min-h-[min(100dvh,820px)] flex flex-col items-center justify-center px-4 sm:px-6 py-24 text-center">
        ...
        <p className="mb-6 rounded-full border border-cyan-600/25 bg-white/50 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.25em] text-cyan-800">
          KASDISTRO
        </p>
        ...
        <p className="mt-6 text-lg sm:text-xl text-zinc-600 max-w-2xl">
          One tool. Multiple wallets. One transaction flow.
        </p>
        <p className="mt-4 text-base text-zinc-500 max-w-3xl leading-relaxed">
        ...
        <p className="mt-6 text-cyan-800 font-medium">
          Load your list. Set your rewards. Send the KAS.
        </p>
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <CtaButton large />
          <a href="#how-it-works" className="text-sm text-zinc-500 hover:text-zinc-900 transition">
            See how it works →
          </a>
        </div>
      </section>

      <section id="features" className="border-t border-cyan-900/10 py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="max-w-2xl mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-zinc-900">Built for Community Rewards</h2>
          ...
          <div className="flex flex-wrap gap-2">
            {USE_CASES.map((item) => (
              <span key={item} className="kd-glass px-4 py-2 rounded-full text-sm text-zinc-700">
                {item}
              </span>
            ))}
          </div>
      ...
      <section id="how-it-works" className="border-t border-cyan-900/10 py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {STEPS.map((step) => (
              ...
              >
                <span className="text-cyan-700 font-mono text-sm font-bold">{step.num}</span>
      ...
      <section id="fees" className="border-t border-cyan-900/10 py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <h2 className="text-2xl sm:text-3xl font-bold text-zinc-900">Simple, Transparent Fees</h2>
          ...
          <div className="max-w-lg mx-auto">
            <div className="kd-glass-strong rounded-2xl p-8 space-y-4">
              <h3 className="font-semibold text-zinc-900">Before you confirm</h3>
              {[
              ...
              <div className="kd-glass rounded-xl p-4 flex justify-between border-cyan-500/20">
                ...
                <span className="text-zinc-900 text-sm">Distribution + all fees</span>
              </div>
          ...
          <div className="grid sm:grid-cols-4 gap-4 mt-12 max-w-4xl mx-auto">
            {[
              ...
              <div key={title} className="text-center">
                <Icon className="h-5 w-5 text-cyan-600 mx-auto mb-2" />
      ...
      <section id="token-distribution" className="border-t border-cyan-900/10 py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <h2 className="text-2xl sm:text-3xl font-bold text-zinc-900">Token Distribution</h2>
            <p className="mt-3 text-zinc-500 max-w-xl mx-auto">
      ...
      <section className="border-t border-cyan-900/10 py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-zinc-900">Made for More Than Token Projects</h2>
      ...
      <section className="border-t border-cyan-900/10 py-20 sm:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-zinc-600 mb-2">You decide who receives KAS and how much.</p>
          <p className="text-zinc-700 font-medium">Bulk distribution made simple.</p>
        </div>
      </section>

      <section id="distro" className="border-t border-cyan-900/10 py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-zinc-900">Distro</h2>
            <p className="mt-3 text-zinc-500 max-w-xl mx-auto">
